...
birds(%w(raven finch hawk eagle)) { |_, _, *raps| p raps}
# ["hawk", "eagle"]

# Note: without the splat operator in the array arguments, only "hawk" would be
# accepted, with "eagle" being discarded.
